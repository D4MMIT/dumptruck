...
Blacklist::Blacklist(std::string BlockPath,std::string blacklistfile, std::string backupfile)
{
    blockPath = BlockPath;
...
void Blacklist::backUp(std::string fname, Paragraph T)
{
    erase_file(fname);
    std::ofstream backUp; backUp.open(fname);
...
void Blacklist::block()
{
    ...
    std::vector<std::string> defaults{"www.youtube.com","youtube.com","www.youtube.com", "youtu.be","www.youtu.be","youtube-nocookie.com","www.youtube-nocookie.com","m.youtube.com"
        ,"www.facebook.com","facebook.com","www.twitter.com","twitter.com","whatsapp.com","tiktok.com","","tetris.com","slither.io",
        "moomoo.io","powerline.io","wings.io"};
